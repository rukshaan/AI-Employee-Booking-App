  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.headerBox}>
        <FormHeader leftHeading='Sign In' rightHeading='Create Account' subHeading='Employee Portal' rightHeaderOpacity={rightHeaderOpacity} leftHeaderTranslateX={leftHeaderTranslateX} rightHeaderTranslateY={rightHeaderTranslateY} />
      </View>
      ...
      <ScrollView ref={scrollview} horizontal pagingEnabled showsHorizontalScrollIndicator={false} scrollEventThrottle={16} onScroll={Animated.event([{ nativeEvent: { contentOffset: { x: animation } } }], { useNativeDriver: false })} style={styles.formScroll}>
        <View style={styles.page}><LoginForm role='employee' /></View>
        <View style={styles.page}><SignupForm role='employee' /></View>
      </ScrollView>
    </View>
  );
};
